...
export class AdminNFTLottry extends Component {
  constructor(props) {
    super(props);
    this.stateLouttry();
  ...
  stateLouttry  =  async () => {
    ...
    const contract_abi=require('./../nftLouttry.json');
    const contract_address="0x275f99809e045b3656bc989cb51e0b9934482ab8";
